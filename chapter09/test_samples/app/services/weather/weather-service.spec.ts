...
import {WeatherResult, WeatherService, WEATHER_URL_BASE, WEATHER_URL_SUFFIX} from "./weather-service";
...
describe("WeatherService", () => {
    ...
    it("getWeather() should return weather for New York", done => {
        ...
        service.getWeather("New York").subscribe((weather: WeatherResult) => {
